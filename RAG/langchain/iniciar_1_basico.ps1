<#
    RAG basico con LangChain (LCEL) para clase.
    Uso:
      .\iniciar_1_basico.ps1                  -> modo interactivo
      .\iniciar_1_basico.ps1 "que es RAG?"    -> una sola pregunta y listo
#>
...
# 4. Correr la demo
Write-Paso "Iniciando RAG basico (LangChain)..."
if ($Pregunta -and $Pregunta.Count -gt 0) {
    python 1_rag_basico.py @Pregunta
} else {
