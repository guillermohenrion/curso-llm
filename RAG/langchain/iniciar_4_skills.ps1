<#
    RAG con skills (LangChain) para clase.
    Uso:
      .\iniciar_4_skills.ps1                  -> modo interactivo
      .\iniciar_4_skills.ps1 "que es RAG?"    -> una sola pregunta y listo
#>
...
# 4. Correr la demo
Write-Paso "Iniciando RAG con skills (LangChain)..."
if ($Pregunta -and $Pregunta.Count -gt 0) {
    python 4_rag_skills.py @Pregunta
} else {
