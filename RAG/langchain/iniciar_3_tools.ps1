<#
    RAG con tools/agente (LangChain) para clase.
    Uso:
      .\iniciar_3_tools.ps1                  -> modo interactivo
      .\iniciar_3_tools.ps1 "que es RAG?"    -> una sola pregunta y listo
#>
...
# 4. Correr la demo
Write-Paso "Iniciando RAG con tools (LangChain)..."
if ($Pregunta -and $Pregunta.Count -gt 0) {
    python 3_rag_tools.py @Pregunta
} else {
